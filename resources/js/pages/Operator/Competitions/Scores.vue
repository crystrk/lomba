...
import { toggleOngoing as toggleOngoingRoute } from '@/routes/operator/matches';
import { update as updateSchedule } from '@/routes/operator/matches/schedule';
import { update as updateScore } from '@/routes/operator/matches/score';
            ...
            >
                ...
                <div class="space-y-0.5">
                    ...
                    <p class="text-xs text-rose-700 dark:text-rose-300">
                        Admin telah mengunci hasil seluruh pertandingan secara final. Skor tidak dapat diubah lagi.
                    </p>
                </div>
            </div>
            ...
            >
                ...
                <div class="space-y-0.5">
                    ...
                    <p class="text-xs text-amber-700 dark:text-amber-300">
                        ...
                        Admin harus mengunci bagan/jadwal (Status Terkunci/Locked) sebelum skor dapat disimpan.
                    </p>
                </div>
            </div>
                ...
                <Card v-if="playableMatches.length === 0" class="p-8 text-center rounded-2xl">
                    <div class="max-w-xs mx-auto space-y-2">
                        ...
                        <p class="text-xs text-muted-foreground">
                            Pertandingan belum diundi atau belum ditugaskan untuk lomba ini.
                        </p>
                    </div>
                </Card>
